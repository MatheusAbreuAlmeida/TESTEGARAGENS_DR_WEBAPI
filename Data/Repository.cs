...
namespace TESTEGARAGENS_DR_WEBAPI.Data
{
    public class Repository : IRepository
    {
        ...
        public Passagem GetSinglePassagemById(int id, string cod)
        {
            IQueryable<Passagem> query = _context.Passagens;
        ...
        public Garagem GetSingleGaragemByCod(string cod)
        {
            IQueryable<Garagem> query = _context.Garagens;
        ...
        public FormaPagamento GetSingleFormaPagamentoByCod(string cod)
        {
            IQueryable<FormaPagamento> query = _context.FormasPagamento;
        ...
        public decimal TotalPrizeCalc(Passagem passagem)
        {
            ...
            {
                TimeSpan estadia = (TimeSpan)(passagem.DataHoraSaida - passagem.DataHoraEntrada);
